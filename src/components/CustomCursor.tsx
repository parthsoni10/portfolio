...
export const CustomCursor = () => {
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-12 h-12 border border-accent rounded-full pointer-events-none z-50 mix-blend-difference shadow-[0_0_10px_var(--color-accent)]"
        animate={{
